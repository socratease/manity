...
class Assignee(TypedDict, total=False):
    id: str
    name: str
    team: str
    email: Optional[str]
...
class SubtaskBase(SQLModel):
    ...
    assignee: Optional[Assignee] = Field(default=None, sa_column=Column(JSON))
...
class ActivityBase(SQLModel):
    ...
    note: str
    author: str
    taskContext: Optional[TaskContext] = Field(default=None, sa_column=Column(JSON))
