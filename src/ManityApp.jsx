      ...
      <main style={styles.main}>
        ...
        {viewingProject ? (
          ...
          <MomentumChat
            ...
            thrustConversation={thrustConversation}
            thrustIsRequesting={thrustIsRequesting}
            thrustPendingActions={thrustPendingActions}
            thrustError={thrustError}
            thrustDraft={thrustDraft}
            handleThrustDraftChange={handleThrustDraftChange}
            showThrustTagSuggestions={showThrustTagSuggestions}
            thrustTagSearchTerm={thrustTagSearchTerm}
            selectedThrustTagIndex={selectedThrustTagIndex}
            insertThrustTag={insertThrustTag}
            setSelectedThrustTagIndex={setSelectedThrustTagIndex}
            ...
            renderRichTextWithTags={renderRichTextWithTags}
